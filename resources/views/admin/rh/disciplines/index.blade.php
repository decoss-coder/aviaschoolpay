...
<div class="max-w-6xl mx-auto px-4 py-6 space-y-5" x-data="{ editingId: null, showCreate: false }">
    ...
    <div class="flex items-start justify-between gap-3 flex-wrap">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">
                Définissez les disciplines enseignées (FR, MATH, ANG, HG, SVT, PC…). Chaque discipline a un <b>coefficient par défaut</b> utilisé dans le calcul des moyennes générales et peut avoir des <b>sous-disciplines</b> (ex : Français → CF/OG/EO).
            </p>
        </div>
    ...
    <div x-show="showCreate" x-cloak x-transition
        ...
        <form method="POST" action="{{ route('admin.rh.disciplines.store') }}"
            ...
            <div>
                <label class="block text-[10px] font-bold text-gray-500 uppercase mb-1">Coef défaut *</label>
        ...
        <div class="mt-3 px-3 py-2 bg-blue-50 border border-blue-200 rounded-lg text-xs text-blue-700">
            💡 Le <b>groupe</b> détermine le <b>BILAN</b> sur le bulletin officiel (BILAN LET, BILAN SC...). Pour un format conforme au bulletin de Côte d'Ivoire, classez vos matières en <b>Littéraire</b> / <b>Scientifique</b> / <b>Autres</b>.
        </div>
    </div>
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50 border-b border-gray-100">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-center text-xs font-bold text-gray-500 uppercase">Sous-disciplines</th>
                        <th class="px-4 py-2 text-center text-xs font-bold text-gray-500 uppercase">Affectations</th>
