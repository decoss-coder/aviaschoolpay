...
<div x-data="enseignantForm()" class="max-w-6xl mx-auto">
    <form method="POST" action="{{ route('enseignants.update', $enseignant) }}" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="flex items-center justify-between mb-4">
            <a href="{{ route('enseignants.show', $enseignant) }}" class="inline-flex items-center gap-2 text-sm font-semibold text-gray-500 hover:text-brand-600 transition-colors">
                ...
                <div class="relative overflow-hidden bg-gradient-to-br from-white via-white to-brand-50/30 rounded-2xl border border-brand-100/60 shadow-card-brand p-6">
                    ...
                    <div class="relative grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="nom" x-model="nom" value="{{ old('nom', $enseignant->nom) }}" required class="w-full px-3 py-2.5 bg-white border border-brand-100 rounded-xl text-sm placeholder:text-gray-400 focus:border-brand-400 focus:ring-2 focus:ring-brand-100 outline-none transition-all shadow-sm">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="prenom" x-model="prenom" value="{{ old('prenom', $enseignant->prenom) }}" required class="w-full px-3 py-2.5 bg-white border border-brand-100 rounded-xl text-sm placeholder:text-gray-400 focus:border-brand-400 focus:ring-2 focus:ring-brand-100 outline-none transition-all shadow-sm">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                <label class="relative flex items-center justify-center gap-2 px-3 py-2.5 bg-white border border-brand-100 rounded-xl cursor-pointer hover:border-blue-300 transition-all has-[:checked]:bg-gradient-to-br has-[:checked]:from-blue-50 has-[:checked]:to-blue-100/50 has-[:checked]:border-blue-300 has-[:checked]:shadow-sm">
                                    <input type="radio" name="sexe" value="M" x-model="sexe" required class="sr-only peer" {{ old('sexe', $enseignant->sexe) === 'M' ? 'checked' : '' }}>
                                ...
                                <label class="relative flex items-center justify-center gap-2 px-3 py-2.5 bg-white border border-brand-100 rounded-xl cursor-pointer hover:border-pink-300 transition-all has-[:checked]:bg-gradient-to-br has-[:checked]:from-pink-50 has-[:checked]:to-pink-100/50 has-[:checked]:border-pink-300 has-[:checked]:shadow-sm">
                                    <input type="radio" name="sexe" value="F" x-model="sexe" class="sr-only peer" {{ old('sexe', $enseignant->sexe) === 'F' ? 'checked' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="date" name="date_naissance" value="{{ old('date_naissance', optional($enseignant->date_naissance)->format('Y-m-d')) }}" class="w-full px-3 py-2.5 bg-white border border-brand-100 rounded-xl text-sm focus:border-brand-400 focus:ring-2 focus:ring-brand-100 outline-none transition-all shadow-sm">
                        </div>

                        <div>
                            <label class="block text-[11px] font-bold text-gray-700 uppercase tracking-wider mb-1.5">Matricule MENA</label>
                            <input type="text" name="matricule_mena" value="{{ old('matricule_mena', $enseignant->matricule_mena) }}" maxlength="30" placeholder="MENA-XXXX" class="w-full px-3 py-2.5 bg-white border border-brand-100 rounded-xl text-sm font-mono placeholder:text-gray-400 focus:border-brand-400 focus:ring-2 focus:ring-brand-100 outline-none transition-all shadow-sm">
                        </div>

                        <div class="md:col-span-2">
                            @if(!empty($enseignant->photo_path))
                                <div class="mb-3">
                                    <p class="text-[11px] font-bold text-gray-700 uppercase tracking-wider mb-2">Photo actuelle</p>
                                    <img src="{{ route('enseignants.photo', $enseignant) }}" alt="{{ $enseignant->nom_complet }}" class="w-24 h-24 rounded-2xl object-cover border border-brand-100 shadow-sm">
                                </div>
                            @endif
                            <label class="block text-[11px] font-bold text-gray-700 uppercase tracking-wider mb-1.5">Changer la photo</label>
                ...
                <div class="relative overflow-hidden bg-gradient-to-br from-white via-white to-blue-50/30 rounded-2xl border border-blue-100/60 shadow-card-blue p-6">
                    ...
                    <div class="relative grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="telephone" value="{{ old('telephone', $enseignant->telephone) }}" required maxlength="20" placeholder="+225 XX XX XX XX XX" class="w-full px-3 py-2.5 bg-white border border-blue-100 rounded-xl text-sm placeholder:text-gray-400 focus:border-blue-400 focus:ring-2 focus:ring-blue-100 outline-none transition-all shadow-sm">
                        </div>

                        <div>
                            <label class="block text-[11px] font-bold text-gray-700 uppercase tracking-wider mb-1.5">Téléphone 2</label>
                            <input type="text" name="telephone_2" value="{{ old('telephone_2', $enseignant->telephone_2) }}" maxlength="20" placeholder="+225 XX XX XX XX XX" class="w-full px-3 py-2.5 bg-white border border-blue-100 rounded-xl text-sm placeholder:text-gray-400 focus:border-blue-400 focus:ring-2 focus:ring-blue-100 outline-none transition-all shadow-sm">
                        </div>

                        <div class="md:col-span-2">
                            <label class="block text-[11px] font-bold text-gray-700 uppercase tracking-wider mb-1.5">Email</label>
                            <input type="email" name="email" value="{{ old('email', $enseignant->email) }}" placeholder="prof@exemple.com" class="w-full px-3 py-2.5 bg-white border border-blue-100 rounded-xl text-sm placeholder:text-gray-400 focus:border-blue-400 focus:ring-2 focus:ring-blue-100 outline-none transition-all shadow-sm">
                        </div>

                        <div class="md:col-span-2">
                            <label class="block text-[11px] font-bold text-gray-700 uppercase tracking-wider mb-1.5">Adresse</label>
                            <textarea name="adresse" rows="2" placeholder="Quartier, commune, ville" class="w-full px-3 py-2.5 bg-white border border-blue-100 rounded-xl text-sm placeholder:text-gray-400 focus:border-blue-400 focus:ring-2 focus:ring-blue-100 outline-none transition-all shadow-sm resize-none">{{ old('adresse', $enseignant->adresse) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative overflow-hidden bg-gradient-to-br from-white via-white to-gold-50/40 rounded-2xl border border-gold-200/60 shadow-card-gold p-6">
                    ...
                    <div class="relative grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="statut" x-model="statut" required class="w-full px-3 py-2.5 bg-white border border-gold-200 rounded-xl text-sm focus:border-gold-400 focus:ring-2 focus:ring-gold-100 outline-none transition-all shadow-sm cursor-pointer">
                                @foreach($statutsDisponibles as $item)
                                    <option value="{{ $item }}" {{ old('statut', $enseignant->statut) === $item ? 'selected' : '' }}>{{ ucfirst($item) }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="date_prise_fonction" value="{{ old('date_prise_fonction', optional($enseignant->date_prise_fonction)->format('Y-m-d')) }}" class="w-full px-3 py-2.5 bg-white border border-gold-200 rounded-xl text-sm focus:border-gold-400 focus:ring-2 focus:ring-gold-100 outline-none transition-all shadow-sm">
                        </div>

                        <div>
                            <label class="block text-[11px] font-bold text-gray-700 uppercase tracking-wider mb-1.5">Salaire de base (FCFA)</label>
                            <div class="relative">
                                <input type="number" name="salaire_base" value="{{ old('salaire_base', $enseignant->salaire_base) }}" min="0" step="1" class="w-full px-3 py-2.5 pr-14 bg-white border border-gold-200 rounded-xl text-sm font-bold text-gold-700 focus:border-gold-400 focus:ring-2 focus:ring-gold-100 outline-none transition-all shadow-sm">
                        ...
                        <div>
                            ...
                            <input type="text" name="banque" value="{{ old('banque', $enseignant->banque) }}" maxlength="100" class="w-full px-3 py-2.5 bg-white border border-gold-200 rounded-xl text-sm placeholder:text-gray-400 focus:border-gold-400 focus:ring-2 focus:ring-gold-100 outline-none transition-all shadow-sm">
                        </div>

                        <div class="md:col-span-2">
                            <label class="block text-[11px] font-bold text-gray-700 uppercase tracking-wider mb-1.5">Numéro de compte</label>
                            <input type="text" name="numero_compte" value="{{ old('numero_compte', $enseignant->numero_compte) }}" maxlength="50" class="w-full px-3 py-2.5 bg-white border border-gold-200 rounded-xl text-sm font-mono placeholder:text-gray-400 focus:border-gold-400 focus:ring-2 focus:ring-gold-100 outline-none transition-all shadow-sm">
                        </div>
                    </div>
                </div>
            </div>
...
function enseignantForm() {
    return {
        nom: @json(old('nom', $enseignant->nom)),
        prenom: @json(old('prenom', $enseignant->prenom)),
        sexe: @json(old('sexe', $enseignant->sexe)),
        specialite: @json(old('specialite', $enseignant->specialite)),
        statut: @json(old('statut', $enseignant->statut)),
    }
}
</script>
@endpush
