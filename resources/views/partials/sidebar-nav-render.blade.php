...
@php
    ...
    if ($canSeeSchoolSettings) {
        ...
        $schoolSettingItems[] = [
            'r' => 'emploi-du-temps.salles.index',
            'match' => 'emploi-du-temps.salles.*',
            'label' => 'Salles',
            'd' => 'M8 3h8l4 4v14a2 2 0 01-2 2H6a2 2 0 01-2-2V7l4-4z M9 21v-6h6v6 M9 10h.01 M12 10h.01 M15 10h.01',
        ];
    }
